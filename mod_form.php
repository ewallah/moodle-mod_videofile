...
class mod_videofile_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        // Video fields.
        $mform->addElement('header', 'video_fieldset', get_string('video_fieldset', 'videofile'));

        // Width.
        $mform->addElement('text', 'width', get_string('width', 'videofile'), ['size' => 4]);
        ...
        // Height.
        $mform->addElement('text', 'height', get_string('height', 'videofile'), ['size' => 4]);
        ...
        // Video file manager.
        $options = ['subdirs' => false, 'maxbytes' => 0, 'maxfiles' => -1, 'accepted_types' => ['.mp4', '.webm', '.ogv']];
        ...
        $options = ['subdirs' => false, 'maxbytes' => 0, 'maxfiles' => 1, 'accepted_types' => ['image']];
        $mform->addElement('filemanager', 'posters', get_string('posters', 'videofile'), null, $options);
        $mform->addHelpButton('posters', 'posters', 'videofile');

        // Captions file manager.
        $options = ['subdirs' => false, 'maxbytes' => 0, 'maxfiles' => -1, 'accepted_types' => ['.vtt']];
        $mform->addElement('filemanager', 'captions', get_string('captions', 'videofile'), null, $options);
    ...
    public function data_preprocessing(&$defaultvalues) {
        if ($this->current->instance) {
            ...
            file_prepare_draft_area($draftitemid, $this->context->id, 'mod_videofile', 'videos', 0, $options);
